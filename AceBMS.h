...
#define ACEBMS_STATUS (0x00)
#define ACEBMS_VBANK1 (0x01)
#define ACEBMS_VBANK2 (0x02)
#define ACEBMS_TEMPER (0x03)
...
#define ACEBMS_ITRG (ACEBMS_STATUS | SIG_BYTE | SIG_OFF6 | SIG_CENT)
#define ACEBMS_RQST (ACEBMS_STATUS | SIG_BYTE | SIG_OFF7 | SIG_UNIT)
...
#define ACEBMS_NAMES                                                           \
  {"Vbat", ACEBMS_VBAT}, {"Vtrg", ACEBMS_VTRG}, {"Ibat", ACEBMS_IBAT},         \
      {"Itrg", ACEBMS_ITRG}, {"Req", ACEBMS_RQST}, {"Vc1", ACEBMS_CEL1},       \
      {"Vc2", ACEBMS_CEL2}, {"Vc3", ACEBMS_CEL3}, {"Vc4", ACEBMS_CEL4},        \
      {"Vc5", ACEBMS_CEL5}, {"Vc6", ACEBMS_CEL6}, {"Vc7", ACEBMS_CEL7},        \
      {"Vc8", ACEBMS_CEL8}, {"Vbal", ACEBMS_VBAL}, {"ChAh", ACEBMS_CHAH},      \
      {"BTc1", ACEBMS_BTC1}, {"BTc2", ACEBMS_BTC2}
